...
class ValidateGroupsScreen extends StatefulWidget {
  const ValidateGroupsScreen({super.key});

  @override
  _ValidateGroupsScreenState createState() => _ValidateGroupsScreenState();
}

class _ValidateGroupsScreenState extends State<ValidateGroupsScreen> {
